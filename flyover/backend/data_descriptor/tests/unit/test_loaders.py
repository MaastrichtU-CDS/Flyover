"""
Unit tests for the JSON-LD loader (loaders/jsonld_loader.py).

Tests cover:
- SchemaReconstructionNode, SchemaVariable, and ColumnMapping dataclasses,
  including edge cases (missing targetClass, list-valued localColumn,
  null local mappings, non-standard mapsTo values)
...
- Legacy format conversion and annotation entry generation
- get_prefixes_string() SPARQL PREFIX output
"""
...
# ---------------------------------------------------------------------------
# SchemaReconstructionNode dataclass
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# SchemaVariable dataclass
# ---------------------------------------------------------------------------


class TestSchemaVariable(unittest.TestCase):
    """Test the SchemaVariable dataclass, including edge cases."""
...
class TestColumnMapping(unittest.TestCase):
    """Test the ColumnMapping dataclass, including edge cases."""
...
# ---------------------------------------------------------------------------
# Legacy format and annotation entry conversion
# ---------------------------------------------------------------------------


class TestLegacyAndAnnotationConversion(unittest.TestCase):
    """Conversion to the legacy format and annotation entries."""
    ...
    def test_to_legacy_format(self):
        ...
        legacy = self.mapping.to_legacy_format()
