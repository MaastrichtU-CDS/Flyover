...
<template>
  <div>
    <h1><i class="fas fa-cookie-bite"></i> Ingest your data</h1>
    <hr />
    <p>
    ...
    >
      <div class="form-group">
        ...
        <input id="CSV" v-model="fileType" type="radio" name="fileType" value="CSV" />
      </div>
      ...
      <div v-show="fileType === 'CSV'">
        ...
        <div v-show="showPkFkSection" class="mt-4">
          <hr />
          <div class="alert alert-info">
            <strong
              ><i class="fas fa-info-circle"></i> Multiple CSV Files Detected</strong
            ><br />
          ...
          >
            ...
            <div class="card-body">
              ...
              <div v-show="fkSelections[index]" class="row">
                <div class="col-md-6">
                  <div class="form-group">
        ...
        <div v-if="graphExists" v-show="showDataLinkingSection" class="mt-4">
          <hr />
          <div class="alert alert-info">
            <strong><i class="fas fa-link"></i> Link Your New Data to Existing Graph Data</strong
            ><br />
            <p>
          ...
          <div v-show="enableDataLinking">
            <div class="card">
              <div class="card-header"><h6 class="mb-0">Configure Data Links</h6></div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
      ...
      <div v-show="fileType === 'Postgres'">
        ...
        <input id="username" v-model="pgUsername" type="text" name="username" />
        <br />
        <label for="password">PostgreSQL Password:</label>
        <input id="password" v-model="pgPassword" type="password" name="password" />
        <br />
        <label for="POSTGRES_URL">PostgreSQL URL:</label>
        <input id="POSTGRES_URL" v-model="pgUrl" type="text" name="POSTGRES_URL" />
        <br />
        <label for="POSTGRES_DB">PostgreSQL Database:</label>
        <input id="POSTGRES_DB" v-model="pgDb" type="text" name="POSTGRES_DB" />
      </div>

      <input id="pkFkData" type="hidden" name="pkFkData" :value="pkFkDataJson" />
      ...
      >
        <i class="fas" :class="submitting ? 'fa-cookie' : 'fa-play'"></i>
      ...
      <template v-if="graphExists">
        ...
        <p>
          ...
          <i
            >It is possible to add more data to this graph, for that you can use the data
            upload available above.</i
          ><br />
          <i
            >It is, however, possible to describe the existing data without having to add
