...
| **Reactive UI** | Vue.js 3 (build-time download) | Complex form state, pagination, live validation |
...
- **CDN**: Vue.js 3 is downloaded during Docker build (`static/js/vue.global.prod.js`) — no runtime internet connection or build tools required
